...
/**
 * Types-only Water Activity Test Result Form (LSP-7.8-F016-WA) bound to WA-01.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $meta = OfficialAnalysisCatalog::resultFormRegistry()['water_activity'] ?? null;
        ...
        if (! $revision) {
            $revision = $form->revisions()->create([
                ...
                'notes' => 'Water Activity F016 types-only dynamic matrix — deploy default revision 1.',
            ]);
        }
