...
/**
 * Types-only Milk Sample Test Result Form (LSP-7.8-F016-MILK) bound to MK-01..MK-05.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $meta = OfficialAnalysisCatalog::resultFormRegistry()['milk'] ?? null;
        ...
        if (! $revision) {
            $revision = $form->revisions()->create([
                ...
                'notes' => 'Milk F016 types-only dynamic matrix — deploy default revision 1.',
            ]);
        }
