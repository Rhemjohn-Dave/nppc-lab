...
/**
 * Types-only Chloramphenicol Test Result Form (LSP-7.8-F016-CAP) bound to FD-CAP.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        $meta = OfficialAnalysisCatalog::resultFormRegistry()['chloramphenicol'] ?? null;
        ...
        if (! $revision) {
            $revision = $form->revisions()->create([
                ...
                'notes' => 'Chloramphenicol F016 types-only dynamic matrix — deploy default revision 1.',
            ]);
        }
