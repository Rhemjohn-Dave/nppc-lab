...
/**
 * Field blueprint for LSP-7.8-F016-NO2 (Nitrite Test Result Form).
 * Page size matches FPDI inspect of Nitrite Test Result Form-blank.pdf
 * (Letter 215.9 × 279.4 mm). Scaffold from CAP/WA; calibrate in Form Designer then:
 * php artisan controlled-forms:export-blueprints --form=LSP-7.8-F016-NO2
 *
 * Official matrix: Control Number | Sample Description | Nitrite (mg/kg)
 * with sublabel Spectrophotometric Method. Max-level notes stay on blank PDF.
 */
return [
    'page' => [
        'width' => 215.9,
    ...
    'fields' => [
        ...
        [
            ...
            'y' => 90.0,
            'w' => 145.0,
            // Header + body; height can cover several samples when the JO has many.
            'h' => 80,
            'font_size' => 11,
            'font_family' => 'times',
            'align' => 'L',
